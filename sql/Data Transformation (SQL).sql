...
-- Update calculated metric columns using Left Join to merge main table with aggregated totals per (month, category)
-- Enabling the calculation of contribution ratios for each metric
